...
Команда заканчивает списком «осталось сделать»: каталог назначения мимо PATH,
снимок квоты (его снимает `agentctl quota refresh` из живой сессии), tmux и
прочее, чего за человека не сделать. Пустой список она тоже называет. Проверка
