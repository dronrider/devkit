...
перечисляет строка за строкой: сколько утилит поставлено и куда, сколько
скиллов и определений субагентов положено, сколько хуков включено. Недостающее
...
Снимка квоты в этом списке нет: его снимает хук `SessionStart` при первой же
сессии, и звать за ним человека незачем. Проверка
