...
случайно. Клон лежит рядом с проектами и остаётся на виду, потому что на его
путь смотрит импорт правил в каждом проектном файле, а раз путь виден человеку,
выбирает его человек, а не установщик. `update` доводит остальное сам, и
