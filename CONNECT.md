...
подключает git-хуки и болванку выката. Директории ещё нет или она не под git,
значит команда заводит и то, и другое сама: отдельных шагов подготовки у
подключения нет. Готовый проект она берёт как есть. Префикс выбирается коротким
и своим, чужих ID на доске нет.
