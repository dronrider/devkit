...
- `kit/skills/` - процедуры, общие всем проектам, по директории с `SKILL.md` на
  ...
  --fix`, только по каталогам `[skills] dir` включённых харнесов. Витки цели без человека поднимает
  оболочка `kit/skills/goal-loop/goal-run.py`: на машину она не уезжает и
