...
- `kit/skills/` - процедуры, общие всем проектам, по директории с `SKILL.md` на
  ...
  протухшего), `board-team` держит захват задачи и разбор столкновений, когда
  по одной доске идут несколько рук, `goal-start` ставит цель (диалог, бюджет, файл цели),
