...
- `kit/skills/` - процедуры, общие всем проектам, по директории с `SKILL.md` на
  ...
  devkit по ходу цели, когда его недостаток мешает витку, `proofread` правит
  форму прозы агентов в долгоживящих текстах по типологии DK-173, не трогая
  фактов, команд и терминов словаря. Первые три это
