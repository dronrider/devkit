...
контур. Клон репозитория установщик не делает, его делает человек первой
командой: путь клона это то, на что смотрит импорт правил в каждом проекте.
Порядок команд в [CONNECT.md](CONNECT.md).
