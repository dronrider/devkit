...
MACHINE_ALLOW = (
    ...
    "Bash(regcheck:*)",
    "Bash(obeycheck:*)",
    # devkitctl, git-хуки и уведомитель зовутся интерпретатором путём из
    # чекаута devkit, своих имён в PATH у них нет.
    "Bash(python3:*)",
...
def check(settings, fix=False, worktree_main=None):
    ...
    doctor = DOCTOR if from_main else Path(worktree_main) / "devkitctl" / "devkitctl.py"
