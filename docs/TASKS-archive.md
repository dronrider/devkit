...
| DK-664 | Сторожок цели идёт с голым PATH launchd, и разлив очереди падает | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-664.md](tasks/archive/2026/DK-664.md) |
| DK-635 | Потолок стенных секунд в тестах parallel валит слияние под нагрузкой | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-635.md](tasks/archive/2026/DK-635.md) |
| DK-747 | Круг самопроверки не знает ворота уровня ревью и валит прогон на main | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-747.md](tasks/archive/2026/DK-747.md) |
| DK-739 | Автоматический прогон сценария встаёт на разрешениях и паркует задачу | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-739.md](tasks/archive/2026/DK-739.md) |
...
| DK-750 | Выбор яруса в чате панели доезжает до сессии второй подписки | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-750.md](tasks/archive/2026/DK-750.md) |
| DK-760 | review level поверх записанного замечания клеит строку уровня к нему | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-760.md](tasks/archive/2026/DK-760.md) |
| DK-724 | Конвейер задачи идёт одной живой сессией вместо череды проходов | task | P1 | 2026-09-03 | [tasks/archive/2026/DK-724.md](tasks/archive/2026/DK-724.md) |
| DK-771 | Реплика на запертом вопросе при нечитаемом курсоре едет в очередь клиента, а не падает 502 | task | P2 | 2026-09-03 | [tasks/archive/2026/DK-771.md](tasks/archive/2026/DK-771.md) |
| DK-765 | Живая голова конвейера встаёт на вопросе разрешения и молчит | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-765.md](tasks/archive/2026/DK-765.md) |
| DK-758 | Замечания чужого ревью копятся файлом и публикуются в MR по ключу publish [приёмка: mixed] | task | P2 | 2026-09-03 | [tasks/archive/2026/DK-758.md](tasks/archive/2026/DK-758.md) |
| DK-781 | Разлив поезда проверяет состав до выката и доводит перевод повтором | bug | P1 | 2026-09-03 | [tasks/archive/2026/DK-781.md](tasks/archive/2026/DK-781.md) |
| DK-770 | Хук режет связку cd с командой до классификатора, стоп на человека снят | bug | P0 | 2026-09-03 | [tasks/archive/2026/DK-770.md](tasks/archive/2026/DK-770.md) |
...
| DK-784 | Шапка вопроса со сроком слепляет заголовок и остаток времени | bug | P3 | 2026-09-04 | [tasks/archive/2026/DK-784.md](tasks/archive/2026/DK-784.md) |
| DK-786 | Замыкающая задача фичи несёт в DoD вход для новичка, ревью его спрашивает | task | P2 | 2026-09-04 | [tasks/archive/2026/DK-786.md](tasks/archive/2026/DK-786.md) |
| DK-715 | Вопрос агента через AskUserQuestion живёт в панели до ответа [приёмка: mixed] | task | P1 | 2026-09-04 | [tasks/archive/2026/DK-715.md](tasks/archive/2026/DK-715.md) |
| DK-797 | Ревью чужого MR: замечания для человека, маршрут по строке, итог не в MR | bug | P1 | 2026-09-05 | [tasks/archive/2026/DK-797.md](tasks/archive/2026/DK-797.md) |
| DK-695 | Вопрос ждущей сессии доезжает до панели текстом и вариантами [приёмка: mixed] | bug | P1 | 2026-09-05 | [tasks/archive/2026/DK-695.md](tasks/archive/2026/DK-695.md) |
| DK-801 | Возврат задачи несёт класс причины, сводка печатает долю по постановке | task | P1 | 2026-09-05 | [tasks/archive/2026/DK-801.md](tasks/archive/2026/DK-801.md) |
| DK-803 | Сторожок печатает на стыке фаз остаток окна и действие | task | P1 | 2026-09-05 | [tasks/archive/2026/DK-803.md](tasks/archive/2026/DK-803.md) |
| DK-753 | Строка уровня ревью в корп-контуре несёт sha боковой доски, а не кода | bug | P2 | 2026-09-06 | [tasks/archive/2026/DK-753.md](tasks/archive/2026/DK-753.md) |
| DK-552 | LLD: постановка идёт раундами вопросов, развилки хранятся машинно [приёмка: user] | LLD | P1 | 2026-09-06 | [tasks/archive/2026/DK-552.md](tasks/archive/2026/DK-552.md) |
...
| DK-647 | Молчащий из-за квоты чат доносит человеку причину и срок сброса [приёмка: mixed] | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-647.md](tasks/archive/2026/DK-647.md) |
| DK-701 | Кнопка «Поднять» уходит, остановка работы видна в панели чата [приёмка: mixed] | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-701.md](tasks/archive/2026/DK-701.md) |
| DK-723 | Перезапуски конвейера складываются в один разговор задачи [приёмка: mixed] | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-723.md](tasks/archive/2026/DK-723.md) |
| DK-804 | Ворота старта отказывают при открытой блокирующей развилке | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-804.md](tasks/archive/2026/DK-804.md) |
| DK-807 | Сценарий стенда судит вердиктом модели, калиброванным примерами | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-807.md](tasks/archive/2026/DK-807.md) |
| DK-835 | Постановка любого входа идёт скиллом interview раундами вопросов | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-835.md](tasks/archive/2026/DK-835.md) |
| DK-613 | Скилл work-plan: план работ сессии ведёт одно правило и утилита | task | P2 | 2026-09-06 | [tasks/archive/2026/DK-613.md](tasks/archive/2026/DK-613.md) |
| DK-806 | Дифф агентских файлов без сценария стенда отбивается на слиянии | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-806.md](tasks/archive/2026/DK-806.md) |
| DK-713 | Цель: любой чат панели, даже архивный, принимает реплику и доносит ответ агента | task | P1 | 2026-09-06 | [tasks/archive/2026/DK-713.md](tasks/archive/2026/DK-713.md) |
| DK-615 | DK-503: диспетчер меряет продолжаемого субагента токенами, а не часами | task | P2 | 2026-09-07 | [tasks/archive/2026/DK-615.md](tasks/archive/2026/DK-615.md) |
| DK-850 | Экран архивной задачи в дашборде: тот же состав, что у живой, только без правки | bug | P2 | 2026-09-07 | [tasks/archive/2026/DK-850.md](tasks/archive/2026/DK-850.md) |
| DK-851 | Панель после первой реплики уезжает в прежний чат того же имени tmux | bug | P1 | 2026-09-07 | [tasks/archive/2026/DK-851.md](tasks/archive/2026/DK-851.md), `28e49aca6`, `2b2476328`, `b131c62bc`, `2e4ef0ee3`, `f6bd33e73`, `0fdd27118`, `aa0625d1c`, `ddcc49445` |
| DK-808 | Ревизия ядра и реестра скиллов стендом: вес падает, послушание держится [приёмка: mixed] | task | P1 | 2026-09-07 | [tasks/archive/2026/DK-808.md](tasks/archive/2026/DK-808.md) |
| DK-565 | Цель: мысль до первой правки хранится машинно, а правила проверяются прогоном | task | P1 | 2026-09-07 | [tasks/archive/2026/DK-565.md](tasks/archive/2026/DK-565.md) |
| DK-614 | Скилл board-chat: правила разговора диспетчера живут в devkit | task | P2 | 2026-09-07 | [tasks/archive/2026/DK-614.md](tasks/archive/2026/DK-614.md) |
| DK-859 | Новый чат в освободившемся окне tmux склеивается с архивными заходами прежних жильцов | bug | P1 | 2026-09-07 | [tasks/archive/2026/DK-859.md](tasks/archive/2026/DK-859.md) |
| DK-612 | Дашборд перестаёт приписывать правила к заданию сессии | task | P2 | 2026-09-08 | [tasks/archive/2026/DK-612.md](tasks/archive/2026/DK-612.md) |
| DK-861 | Кольцо закрытой задачи не сходится из-за брошенных планов субагентов | bug | P2 | 2026-09-08 | [tasks/archive/2026/DK-861.md](tasks/archive/2026/DK-861.md) |
| DK-870 | Конвейер гасит воронкой сессию, ждущую субагентов или приёмки человеком | bug | P1 | 2026-09-08 | [tasks/archive/2026/DK-870.md](tasks/archive/2026/DK-870.md) |
| DK-872 | Список чатов при возврате в разговор показывает старый состав | bug | P2 | 2026-09-08 | [tasks/archive/2026/DK-872.md](tasks/archive/2026/DK-872.md) |
| DK-696 | Панель показывает ждущие ответа задачи и ведёт прямо к вопросу [приёмка: mixed] | task | P2 | 2026-09-09 | [tasks/archive/2026/DK-696.md](tasks/archive/2026/DK-696.md), `9be21738a` |
...
| DK-510 | Сторож снаружи процесса поднимает упавшую сессию заново | task | P1 | 2026-09-10 | [tasks/archive/2026/DK-510.md](tasks/archive/2026/DK-510.md) |
| DK-893 | Плашка работы в чате не встаёт при открытии и гаснет на десятой минуте | bug | P1 | 2026-09-10 | [tasks/archive/2026/DK-893.md](tasks/archive/2026/DK-893.md) |
| DK-863 | Конец сессии засоряет ленту хвостом терминала и глотает реплику человека | bug | P2 | 2026-09-10 | [tasks/archive/2026/DK-863.md](tasks/archive/2026/DK-863.md) |
| DK-860 | Фиктивная запись реестра забирает имя окна у живого чата задачи | bug | P1 | 2026-09-10 | [tasks/archive/2026/DK-860.md](tasks/archive/2026/DK-860.md) |
| DK-899 | Оболочка снимает голову, которая ждёт машинного события | bug | P1 | 2026-09-10 | [tasks/archive/2026/DK-899.md](tasks/archive/2026/DK-899.md) |
| DK-914 | Сессия без задачи получает правила плана и отзывчивости, указатель зовёт скилл | bug | P2 | 2026-09-11 | [tasks/archive/2026/DK-914.md](tasks/archive/2026/DK-914.md) |
| DK-922 | Ответ человека возвращает строку в работу, а сессию задачи поднимать некому | bug | P1 | 2026-09-11 | [tasks/archive/2026/DK-922.md](tasks/archive/2026/DK-922.md) |
| DK-916 | Интервью идёт вглубь по кейсам, а внутренности уходят исполнителю [приёмка: mixed] | task | P1 | 2026-09-11 | [tasks/archive/2026/DK-916.md](tasks/archive/2026/DK-916.md) |
| DK-931 | Команда taskctl run поднимает голову задачи лестницей носителей | task | P1 | 2026-09-11 | [tasks/archive/2026/DK-931.md](tasks/archive/2026/DK-931.md) |
| DK-938 | Кнопка чата у цели открывает мёртвый груминг, реплика не доходит до «Входящих» | bug | P1 | 2026-09-11 | [tasks/archive/2026/DK-938.md](tasks/archive/2026/DK-938.md), `1279e699`, `4fdfd287`, `95ebdafc`, `c7cab464`, `66fe22dc`, `492870f1`, `752b552d`, `88847f6c`, `206f1f17` |
| DK-933 | LLD: взвод ребра «после», уровни цепочки и выстрел по слиянию кода | LLD | P1 | 2026-09-11 | [tasks/archive/2026/DK-933.md](tasks/archive/2026/DK-933.md) |
...
| DK-934 | Взведённая строка стартует сама по слиянию предпосылки | task | P1 | 2026-09-12 | [tasks/archive/2026/DK-934.md](tasks/archive/2026/DK-934.md) |
| DK-936 | Стенд трёх ожиданий на временном репозитории | task | P1 | 2026-09-12 | [tasks/archive/2026/DK-936.md](tasks/archive/2026/DK-936.md) |
| DK-940 | Команда chain строит цепочку уровнями | task | P1 | 2026-09-12 | [tasks/archive/2026/DK-940.md](tasks/archive/2026/DK-940.md) |
| DK-964 | Галочки вариантов груминга встают только после перезагрузки | bug | P2 | 2026-09-12 | [tasks/archive/2026/DK-964.md](tasks/archive/2026/DK-964.md) |
| DK-958 | Вычитка путает хвост «а не» с формой «не X, а Y» | bug | P2 | 2026-09-12 | [tasks/archive/2026/DK-958.md](tasks/archive/2026/DK-958.md) |
| DK-967 | Ворота ёмкости считают работой мёртвые окна tmux | bug | P1 | 2026-09-12 | [tasks/archive/2026/DK-967.md](tasks/archive/2026/DK-967.md) |
| DK-968 | Упавший прогон оставляет временное дерево, и ёмкость занята | bug | P1 | 2026-09-12 | [tasks/archive/2026/DK-968.md](tasks/archive/2026/DK-968.md) |
| DK-962 | Горячий список prose и пары вычитки без «ворот», «рубежа» и одушевления утилит | task | P2 | 2026-09-12 | [tasks/archive/2026/DK-962.md](tasks/archive/2026/DK-962.md) |
| DK-941 | Агент в чате взводит цепочку задач по просьбе человека | task | P1 | 2026-09-13 | [tasks/archive/2026/DK-941.md](tasks/archive/2026/DK-941.md) |
| DK-942 | Диалог цепочки на дашборде, список задач и номера уровней | task | P1 | 2026-09-13 | [tasks/archive/2026/DK-942.md](tasks/archive/2026/DK-942.md) |
| DK-979 | Ход с живой фоновой командой считается холостым, и воронка снимает голову | bug | P1 | 2026-09-13 | [tasks/archive/2026/DK-979.md](tasks/archive/2026/DK-979.md) |
| DK-966 | Воронка снимает голову по фантомным проходам от лишних отметок конца | bug | P0 | 2026-09-13 | [tasks/archive/2026/DK-966.md](tasks/archive/2026/DK-966.md) |
| DK-826 | Записи работы вымывают из реестра привязку живого разговора | bug | P1 | 2026-09-14 | [tasks/archive/2026/DK-826.md](tasks/archive/2026/DK-826.md), `7e62c763`, `c12d62c5`, `077266f1`, `411ee47c`, `8188cc35`, `68e6a884` |
| DK-793 | Стоп и перезапуск чата не спрашивают окно у живого клиента | bug | P1 | 2026-09-14 | [tasks/archive/2026/DK-793.md](tasks/archive/2026/DK-793.md) |
| DK-825 | Архив чата прячет разговор, а процесс в окне живёт дальше | bug | P1 | 2026-09-14 | [tasks/archive/2026/DK-825.md](tasks/archive/2026/DK-825.md) |
| DK-609 | Снятый шаг уходит из плана, а расхождение с делом ловит сторож | task | P2 | 2026-09-14 | [tasks/archive/2026/DK-609.md](tasks/archive/2026/DK-609.md) |
| DK-971 | Ход цикла цели в чате не кончается до стоп-маркера, а сторож видит движение самого цикла | task | P1 | 2026-09-14 | [tasks/archive/2026/DK-971.md](tasks/archive/2026/DK-971.md) |
| DK-992 | Опрос досок дашбордом множится под нагрузкой и валит машину | bug | P1 | 2026-09-14 | [tasks/archive/2026/DK-992.md](tasks/archive/2026/DK-992.md) |
| DK-978 | Чат без плана ловит сторож на втором ходе, а кольцо показывает ракету | task | P2 | 2026-09-14 | [tasks/archive/2026/DK-978.md](tasks/archive/2026/DK-978.md) |
| DK-996 | Скилл work-plan: критерий у пункта, чекпоинт и политика провала | task | P2 | 2026-09-15 | [tasks/archive/2026/DK-996.md](tasks/archive/2026/DK-996.md) |
| DK-852 | Голова разговора выглядит субагентом, и agentctl plan ей отказывает | bug | P1 | 2026-09-15 | [tasks/archive/2026/DK-852.md](tasks/archive/2026/DK-852.md) |
| DK-998 | Тест потолка кеша доски считает запуски, не дождавшись фонового подъёма | bug | P1 | 2026-09-15 | [tasks/archive/2026/DK-998.md](tasks/archive/2026/DK-998.md) |
| DK-1003 | Отбитая команда доски снимает привязку разговора к задаче | bug | P1 | 2026-09-15 | [tasks/archive/2026/DK-1003.md](tasks/archive/2026/DK-1003.md) |
| DK-974 | Обход развилки до парковки вопросом, вопрос без рекомендации отбивается | task | P1 | 2026-09-16 | [tasks/archive/2026/DK-974.md](tasks/archive/2026/DK-974.md) |
| DK-969 | Интервью показывает три состава кейсов, а правка идёт по номерам [приёмка: mixed] | task | P2 | 2026-09-16 | [tasks/archive/2026/DK-969.md](tasks/archive/2026/DK-969.md) |
...
| DK-1022 | Сторож калек на записи: слово из списка вне обратных кавычек получает подсказку с заменой | task | P2 | 2026-09-17 | [tasks/archive/2026/DK-1022.md](tasks/archive/2026/DK-1022.md) |
| DK-1024 | Сторож выборки prose: запись долгоживущего текста без эталонов в контексте отбивается подсказкой с командой и жанром | task | P2 | 2026-09-17 | [tasks/archive/2026/DK-1024.md](tasks/archive/2026/DK-1024.md) |
| DK-957 | Чат цели без плашки про отправку и строки про пустые «Входящие» | task | P1 | 2026-09-18 | [tasks/archive/2026/DK-957.md](tasks/archive/2026/DK-957.md) |
| DK-725 | Цель стоит первой в полосе равных, подтянутые задачи под ней | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-725.md](tasks/archive/2026/DK-725.md) |
| DK-398 | goal-start сверяет бюджет цели с остатком бакета до сброса | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-398.md](tasks/archive/2026/DK-398.md) |
| DK-620 | proofread: инвариант структуры в «Что не трогает», пара DK-428, проход страницы после пунктов | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-620.md](tasks/archive/2026/DK-620.md) |
| DK-618 | Корпус прозы: поля «форма» и «тип» у фрагмента, ключ sample --form, формат блока | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-618.md](tasks/archive/2026/DK-618.md) |
| DK-622 | check-prose.py: текст находки про перестройку с тем же утверждением и пометка в «Ход работы» | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-622.md](tasks/archive/2026/DK-622.md) |
| DK-1025 | Стенд по правилу ядра гоняет раскладку без ядра | bug | P1 | 2026-09-18 | [tasks/archive/2026/DK-1025.md](tasks/archive/2026/DK-1025.md) |
| DK-904 | Сорванный опрос tmux хоронит разговоры и обнуляет занятость задач | bug | P1 | 2026-09-18 | [tasks/archive/2026/DK-904.md](tasks/archive/2026/DK-904.md) |
| DK-889 | Полка ждущих держит архивные и отвеченные разговоры | bug | P2 | 2026-09-18 | [tasks/archive/2026/DK-889.md](tasks/archive/2026/DK-889.md) |
| DK-900 | Субагент затирает план родителя общей меткой agentctl plan | bug | P2 | 2026-09-18 | [tasks/archive/2026/DK-900.md](tasks/archive/2026/DK-900.md) |
| DK-1043 | Форма черновика выбирает исход записи: грумить или сразу выполнить [приёмка: mixed] | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-1043.md](tasks/archive/2026/DK-1043.md) |
| DK-1041 | Поиск с телефона гаснет вместе с клавиатурой при наборе и стирании | bug | P1 | 2026-09-18 | [tasks/archive/2026/DK-1041.md](tasks/archive/2026/DK-1041.md) |
| DK-396 | Сводка считает остановки конвейера по разрядам парковки | task | P1 | 2026-09-18 | [tasks/archive/2026/DK-396.md](tasks/archive/2026/DK-396.md) |
| DK-472 | Процедура записи чистого вердикта в board-ship и промтах ревьювера | task | P1 | 2026-09-18 | [tasks/archive/2026/DK-472.md](tasks/archive/2026/DK-472.md) |
| DK-631 | Тесты привязки и гигиена реестра | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-631.md](tasks/archive/2026/DK-631.md) |
| DK-457 | Отказ съёмщика квоты оставляет след: панель файлом, версии в тексте | task | P2 | 2026-09-18 | [tasks/archive/2026/DK-457.md](tasks/archive/2026/DK-457.md) |
| DK-986 | Вкладка дашборда греет машину: опросы мимо видимости и вечные анимации | bug | P2 | 2026-09-18 | [tasks/archive/2026/DK-986.md](tasks/archive/2026/DK-986.md) |
...
| DK-1132 | Юнит рендера ленты вырезает из статики все нужные функции, go:dashboard зелёный | bug | P0 | 2026-09-23 | [tasks/archive/2026/DK-1132.md](tasks/archive/2026/DK-1132.md) |
| DK-972 | LLD: шаблоны планов организации задают этапы вместо прозы скиллов [приёмка: user] | LLD | P1 | 2026-09-23 | [tasks/archive/2026/DK-972.md](tasks/archive/2026/DK-972.md), `390988668`, `8b3247233`, `a1be05727` |
| DK-1127 | Нагрузочные черновики закрываются замером после выката бюджета машины | task | P1 | 2026-09-24 | [tasks/archive/2026/DK-1127.md](tasks/archive/2026/DK-1127.md) |
| DK-879 | Служебный чат подписан задачей и ролью без haiku, чип не дублирует номер, полоса чипов уже [приёмка: mixed] | task | P1 | 2026-09-24 | [tasks/archive/2026/DK-879.md](tasks/archive/2026/DK-879.md) |
| DK-1128 | poc_panel.mjs: тест смешанной ленты субагента ломает весь прогон стенда | bug | P1 | 2026-09-24 | [tasks/archive/2026/DK-1128.md](tasks/archive/2026/DK-1128.md) |
| DK-746 | Замер ленты дашборда валит слияние на загруженной машине | bug | P1 | 2026-09-24 | [tasks/archive/2026/DK-746.md](tasks/archive/2026/DK-746.md) |
| DK-1038 | Тест цены холостого хода хука chat_in валит слияния под нагрузкой | bug | P1 | 2026-09-24 | [tasks/archive/2026/DK-1038.md](tasks/archive/2026/DK-1038.md) |
| DK-1125 | Итоги прогона по компонентам ложатся в журнал, слияния от чужой красноты считаются командой | task | P1 | 2026-09-24 | [tasks/archive/2026/DK-1125.md](tasks/archive/2026/DK-1125.md) |
...
| DK-1126 | Новый тест меряет факт вместо стенного времени, образец стоит в стандарте, а сторож смотрит дифф | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1126.md](tasks/archive/2026/DK-1126.md) |
| DK-669 | Браузерные тесты дашборда мигают под параллельной нагрузкой машины | bug | P1 | 2026-09-25 | [tasks/archive/2026/DK-669.md](tasks/archive/2026/DK-669.md) |
| DK-1124 | Прогон слияния идёт пониженным приоритетом, дашборд и терминал не голодают | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1124.md](tasks/archive/2026/DK-1124.md) |
| DK-1123 | Потолок параллельности один на прогон и раздан компонентам внутрь | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1123.md](tasks/archive/2026/DK-1123.md) |
| DK-1158 | Скилл chat называет канал вопроса человеку | bug | P2 | 2026-09-25 | [tasks/archive/2026/DK-1158.md](tasks/archive/2026/DK-1158.md) |
| DK-1160 | Цикл цели поднимается после смерти своего носителя | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1160.md](tasks/archive/2026/DK-1160.md) |
| DK-1121 | Команды разбора не делают чат работой строки, кнопка запуска остаётся | bug | P1 | 2026-09-25 | [tasks/archive/2026/DK-1121.md](tasks/archive/2026/DK-1121.md) |
| DK-937 | Интервью обходит проект и возражает до первого вопроса [приёмка: mixed] | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-937.md](tasks/archive/2026/DK-937.md) |
| DK-1157 | Работа поднимается после смерти сессий, включая перезагрузку машины [приёмка: user] | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1157.md](tasks/archive/2026/DK-1157.md) |
| DK-1163 | Утилиты devkit заходят в защищённые папки macOS и спамят диалогами TCC | bug | P1 | 2026-09-25 | [tasks/archive/2026/DK-1163.md](tasks/archive/2026/DK-1163.md) |
| DK-1164 | Ревьювер идёт ярусом исполнителя, спуск на ступень снят | task | P2 | 2026-09-25 | [tasks/archive/2026/DK-1164.md](tasks/archive/2026/DK-1164.md) |
| DK-1120 | Команда и ссылка агента в ленте копируются кнопкой и открываются тапом [приёмка: mixed] | task | P2 | 2026-09-25 | [tasks/archive/2026/DK-1120.md](tasks/archive/2026/DK-1120.md) |
| DK-1162 | Потолок проверяющих сессий с полным прогоном одновременно | task | P1 | 2026-09-25 | [tasks/archive/2026/DK-1162.md](tasks/archive/2026/DK-1162.md), `2790e255e`, `bb69dc576`, `632bed50b`, `d624131c3` |
