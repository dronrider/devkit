...
|--------|--------|-----|---|---|------|--------|
| DK-033 | LLD: devkit как универсальный кит для любых ИИ-агентов | LLD | P3 | 15 (0+8+3+0+4) | L | [tasks/DK-033.md](tasks/DK-033.md) |
| DK-026 | doctor всегда красный на самом devkit: ссылки в архиве задач ведут мимо | bug | P3 | 10 (0+3+0+5+2) | S | [tasks/DK-026.md](tasks/DK-026.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-034 | уведомления, когда сессия ждёт действия или субагент закончил работу | task | P3 | 10 (0+6+1+0+3) | M | [tasks/DK-034.md](tasks/DK-034.md) |
