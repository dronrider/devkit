...
| DK-177 | Назначение яруса в машинном слое: строка via и запись про подписку | task | P2 | 40 (25+8+2+0+5) | M | [tasks/DK-177.md](tasks/DK-177.md) |
...
| DK-040 | agentctl run: делегирование native/cli/none с ограничителем вложенности | task | P2 | 39 (25+8+2+0+4) | L | [lld/DK-033-universal-kit.md](lld/DK-033-universal-kit.md) |
