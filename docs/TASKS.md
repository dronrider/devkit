...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-400 | LLD: парковка вопроса, рубеж, планировщик слота, полка фона и потолки [приёмка: user] | LLD | P1 | 65 (50+8+3+0+4) | M | [tasks/DK-400.md](tasks/DK-400.md) |
...
| DK-402 | Парковка задачи по вопросу и пробуждение тиком watch [после DK-400, DK-345] | task | P1 | 63 (50+8+1+0+4) | M | [tasks/DK-402.md](tasks/DK-402.md) |
| DK-403 | Отвязка wait-human от стопа цикла цели [после DK-402] | task | P1 | 63 (50+8+1+0+4) | S | [tasks/DK-403.md](tasks/DK-403.md) |
| DK-406 | Двухступенчатый Check: агентский прогон после выката освобождает очередь [после DK-400] | task | P1 | 62 (50+7+2+0+3) | M | [tasks/DK-406.md](tasks/DK-406.md) |
...
| DK-345 | почта любой живой сессии, а не только витка цели | task | P2 | 40 (25+8+2+0+5) | M | [tasks/DK-345.md](tasks/DK-345.md) |
...
| DK-404 | Планировщик слота: ворота, счёт внутри полосы, разбор отказа [после DK-401, DK-402] | task | P2 | 39 (25+8+1+0+5) | L | [tasks/DK-404.md](tasks/DK-404.md) |
...
| DK-401 | Рубеж задачи машинным состоянием, переживающим смену статуса [после DK-400] | task | P2 | 37 (25+7+1+0+4) | M | [tasks/DK-401.md](tasks/DK-401.md) |
...
| DK-407 | Карта переходов работы плоскими строками со сторожем полноты [после DK-401] | task | P2 | 35 (25+5+1+0+4) | S | [tasks/DK-407.md](tasks/DK-407.md) |
