...
| DK-266 | shipctl на cmdout: 13 вызовов tail() в ops.go переезжают на обёртку | task | P2 | 33 (25+4+1+0+3) | M | [tasks/DK-266.md](tasks/DK-266.md) |
...
| DK-267 | cmdout: чистка старых выводов, гитигнор, находка doctor | task | P3 | 6 (0+2+2+0+2) | S | - |
