...
| DK-317 | dashboard: строка задачи не знает про идущую работу, ни признака, ни стопа [после DK-316] | bug | P2 | 43 (25+8+3+5+2) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-326 | dashboard: выбор подписки при запуске работы [после DK-328] | task | P2 | 39 (25+8+3+0+3) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-324 | dashboard: движение задачи в бэклоге перетаскиванием с пересчётом ранга [после DK-328, DK-316] [приёмка: mixed] | task | P2 | 34 (25+6+3+0+0) | M | [tasks/DK-327.md](tasks/DK-327.md) |
