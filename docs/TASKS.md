...
| DK-217 | Каркас дашборда: сервер с аутентификацией и доска проектов на чтение | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-217.md](tasks/DK-217.md) |
| DK-226 | secretctl: имена агенту, значение в подпроцесс через два бэкенда | task | P1 | 66 (50+8+3+0+5) | M | [tasks/DK-226.md](tasks/DK-226.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-229 | settings.json: allow без литеральных токенов, копии прочь, находка doctor | task | P1 | 67 (50+7+2+5+3) | M | [tasks/DK-229.md](tasks/DK-229.md) |
| DK-207 | Цель: исключить попадание секретов в контекст модели | task | P1 | 65 (50+8+3+0+4) | XL | [tasks/DK-207.md](tasks/DK-207.md) |
| DK-228 | Рубеж чтения секретов: permissions.deny и PreToolUse-хук на Bash [после DK-226] | task | P1 | 64 (50+7+3+0+4) | M | [tasks/DK-228.md](tasks/DK-228.md) |
| DK-227 | Значения секретов переезжают из access.local.md в secretctl [после DK-226] | task | P1 | 62 (50+7+2+0+3) | M | [tasks/DK-227.md](tasks/DK-227.md) |
...
| DK-218 | Запуск и стоп задачи и цели с дашборда [после DK-217] | task | P2 | 39 (25+8+3+0+3) | M | [tasks/DK-218.md](tasks/DK-218.md) |
...
| DK-219 | Живой статус агента в дашборде: журнал витка, транскрипт, tmux [после DK-217] | task | P2 | 38 (25+8+3+0+2) | M | [tasks/DK-219.md](tasks/DK-219.md) |
| DK-220 | Переписка с агентом через состояние цели [после DK-219] | task | P2 | 38 (25+8+3+0+2) | M | [tasks/DK-220.md](tasks/DK-220.md) |
| DK-222 | Лента уведомлений дашборда и smoke агентской части DoD [после DK-218, DK-220] | task | P2 | 38 (25+7+3+0+3) | M | [tasks/DK-222.md](tasks/DK-222.md) |
...
| DK-221 | Правка задачи и цели с дашборда, зависимости в обе стороны [после DK-217] | task | P2 | 35 (25+5+3+0+2) | M | [tasks/DK-221.md](tasks/DK-221.md) |
| DK-223 | Заход извне и проверка дашборда с телефона [после DK-219, DK-222] | task | P2 | 34 (25+6+3+0+0) | S | [tasks/DK-223.md](tasks/DK-223.md) |
