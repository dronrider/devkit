...
| DK-152 | doctor сверяет версии всех устанавливаемых бинарей, а не mtime четырёх [провал: сценарий п.1: на машине разработчика доктор даёт шесть находок сразу после штатного слияния, потому что сверяет коммит бинаря с HEAD, а HEAD двигает и коммит доски, не трогающий go-исходники] | task | P2 | 35 (25+5+1+0+4) | M | [tasks/DK-152.md](tasks/DK-152.md) |
