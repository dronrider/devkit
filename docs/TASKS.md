...
| DK-394 | taskctl add заводит файл задачи с пустым DoD, изменяющие команды без файла отказывают | task | P3 | 7 (0+3+2+0+2) | M | [tasks/DK-388.md](tasks/DK-388.md) |
...
| DK-391 | board-task: что идёт строкой сразу и что в черновик, файл задачи при заведении, а не при взятии в работу [после DK-390] | task | P3 | 6 (0+3+1+0+2) | M | [tasks/DK-388.md](tasks/DK-388.md) |
...
| DK-392 | goal-loop и goal-cut: ворота заменяются связью с целью, ссылка на цель уходит в файл задачи нарезки | task | P3 | 4 (0+2+1+0+1) | S | [tasks/DK-392.md](tasks/DK-392.md) |
| DK-390 | board-groom держит полное описание трёх ворот, прочие входы ссылаются туда | task | P3 | 3 (0+2+0+0+1) | S | [tasks/DK-390.md](tasks/DK-390.md) |
| DK-393 | goal-start: ворота постановки заменяются DoD цели и бюджетом | task | P3 | 3 (0+2+0+0+1) | S | [tasks/DK-393.md](tasks/DK-393.md) |
