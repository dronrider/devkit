...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-264 | cmdout: утилита-обёртка на общем go-модуле, полный вывод в файл, агенту выжимку | task | P2 | 41 (25+8+3+0+5) | M | [lld/DK-137-cmdout-wrapper.md](lld/DK-137-cmdout-wrapper.md) |
