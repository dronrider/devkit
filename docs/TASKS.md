...
| DK-342 | dashboard: состояние «доставлено агенту» в очереди исходящих и честная плашка чата | task | P2 | 38 (25+8+2+0+3) | M | [tasks/DK-342.md](tasks/DK-342.md) |
...
| DK-358 | dashboard: завершённый груминг висит живой работой до 12 минут | bug | P2 | 37 (25+4+2+5+1) | S | [tasks/DK-358.md](tasks/DK-358.md) |
