...
| DK-324 | dashboard: движение задачи в бэклоге перетаскиванием с пересчётом ранга [приёмка: mixed] | task | P2 | 34 (25+6+3+0+0) | M | [tasks/DK-324.md](tasks/DK-324.md) |
| DK-294 | dashboard: разговор живой сессии без узнанной задачи не открыть | task | P2 | 34 (25+5+3+0+1) | M | [tasks/DK-294.md](tasks/DK-294.md) |
