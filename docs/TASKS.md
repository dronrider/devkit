...
| DK-340 | hookio: ось события инструмента и второй канал ответа протокола | task | P2 | 40 (25+8+2+0+5) | M | [tasks/DK-340.md](tasks/DK-340.md) |
...
| DK-341 | hooks/inbox.py: почтальон доставляет реплики идущему витку на событии инструмента [после DK-340] | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-342 | dashboard: состояние «доставлено агенту» в очереди исходящих и честная плашка чата [после DK-341] | task | P2 | 38 (25+8+2+0+3) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-343 | goal-loop: живая реплика в витке и зов оболочки через python3 [после DK-341] | task | P2 | 38 (25+8+2+0+3) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-345 | почта любой живой сессии, а не только витка цели [после DK-342] | task | P3 | 11 (0+6+2+0+3) | M | - |
