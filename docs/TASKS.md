...
| DK-212 | Ворота перехода в Check: сценарий в файле задачи и слитая ветка | task | P2 | 35 (25+6+1+0+3) | M | [tasks/DK-212.md](tasks/DK-212.md) |
...
| DK-213 | Хук check-commit: ID задачи в коммите на main проекта с доской | task | P2 | 32 (25+4+1+0+2) | S | [tasks/DK-213.md](tasks/DK-213.md) |
