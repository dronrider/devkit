...
| DK-215 | LLD дашборда: границы сервер-клиент, API, аутентификация, раскладка кода | LLD | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-215.md](tasks/DK-215.md) |
| DK-216 | Экраны дашборда в Claude Design: телефон и ноутбук | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-216.md](tasks/DK-216.md) |

## Check (готово, ждёт проверки пользователем)

| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-214 | Копия окна второй подписки едет за main сама | task | P2 | 35 (25+6+1+0+3) | S | [tasks/DK-214.md](tasks/DK-214.md) |
...
| DK-217 | Каркас дашборда: сервер с аутентификацией и доска проектов на чтение [после DK-215, DK-216] | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-217.md](tasks/DK-217.md) |
