...
| DK-244 | Экран задачи дашборда: единая кнопка сохранения, валидация слагаемых по типу, спокойное живое обновление | task | P2 | 37 (25+5+2+5+0) | M | [tasks/DK-244.md](tasks/DK-244.md) |
