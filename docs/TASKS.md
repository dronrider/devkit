...
|--------|--------|-----|---|---|------|--------|
| DK-067 | taskctl list: чего ждёт задача в Check и сколько строка лежит без движения | task | P3 | 8 (0+5+1+0+2) | S | [tasks/DK-067.md](tasks/DK-067.md) |
...
| DK-093 | agentctl: гейт бюджета цели (spend) и потолок яруса в pick (--goal) | task | P2 | 39 (25+7+2+0+5) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
...
| DK-094 | скилл goal-loop, вход постановки: разделы файла цели, строка XL на доске, бюджет диалогом | task | P2 | 38 (25+7+1+0+5) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
| DK-095 | скилл goal-loop, виток: чтение состояния, нарезка, конвейер задачи, журнал, маркеры [после DK-093, DK-094] | task | P2 | 38 (25+8+2+0+3) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
| DK-096 | оболочка goal-run: tmux-цикл витков, замок, защита от воронки, уведомления [после DK-095] | task | P2 | 37 (25+7+2+0+3) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
...
| DK-097 | скилл live-core: порог, канал через порядок devkit, границы | task | P3 | 9 (0+5+2+0+2) | S | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
...
| DK-068 | Развести Blocked и зависимость [после ...]: внешнее обстоятельство против своей же задачи | task | P3 | 5 (0+3+1+0+1) | S | [tasks/DK-068.md](tasks/DK-068.md) |
