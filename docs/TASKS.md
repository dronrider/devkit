...
| DK-177 | Назначение яруса в машинном слое: строка via и запись про подписку | task | P2 | 40 (25+8+2+0+5) | M | [tasks/DK-171.md](tasks/DK-171.md) |
...
| DK-179 | Раскладка машинного контура по профилям включённых харнесов | task | P2 | 39 (25+7+2+0+5) | M | [tasks/DK-171.md](tasks/DK-171.md) |
