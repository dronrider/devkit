...
| DK-107 | Тонкая глобальная точка правил в doctor/setup [провал: шаг 1 сценария: находка про рукописную глобальную точку советует devkitctl doctor --fix, но он такой файл не трогает, и команда из находки к результату не приводит] | task | P2 | 34 (25+5+1+0+3) | S | [tasks/DK-107.md](tasks/DK-107.md) |
