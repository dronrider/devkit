...
| DK-392 | goal-loop и goal-cut: ворота заменяются связью с целью, ссылка на цель уходит в файл задачи нарезки | task | P3 | 4 (0+2+1+0+1) | S | [tasks/DK-388.md](tasks/DK-388.md) |
| DK-390 | board-groom держит полное описание трёх ворот, прочие входы ссылаются туда | task | P3 | 3 (0+2+0+0+1) | S | [tasks/DK-388.md](tasks/DK-388.md) |
| DK-393 | goal-start: ворота постановки заменяются DoD цели и бюджетом | task | P3 | 3 (0+2+0+0+1) | S | [tasks/DK-388.md](tasks/DK-388.md) |
