...
| DK-375 | devkitctl map: генератор карты проекта и индекса решений, сторож свежести, импорт в тонкий файл | task | P2 | 38 (25+6+3+0+4) | M | [tasks/DK-375.md](tasks/DK-375.md) |
...
| DK-376 | POC-замер карты на xr-proxy: пара типовых задач с картой и без, цифры расхода [после DK-375] | task | P2 | 37 (25+6+2+0+4) | M | [tasks/DK-376.md](tasks/DK-376.md) |
