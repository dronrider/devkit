...
|--------|--------|-----|---|---|------|--------|
| DK-125 | Инструкция подключения проекта: два сценария, обычный и корп, без раскладки на пользователя | task | P2 | 36 (25+6+1+0+4) | M | [tasks/DK-125.md](tasks/DK-125.md) |
