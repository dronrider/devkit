...
| DK-220 | Переписка с агентом через состояние цели | task | P2 | 38 (25+8+3+0+2) | M | [tasks/DK-220.md](tasks/DK-220.md) |
...
| DK-223 | Заход извне и проверка дашборда с телефона [после DK-222] | task | P2 | 34 (25+6+3+0+0) | S | [tasks/DK-223.md](tasks/DK-223.md) |
