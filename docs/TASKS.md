...
| DK-296 | dashboard: чат открывается у обычной задачи и зовёт её целью | bug | P2 | 36 (25+4+1+5+1) | S | [tasks/DK-296.md](tasks/DK-296.md) |
| DK-292 | LLD: критерии вида приёмки задачи и место, где он назначается | LLD | P2 | 39 (25+7+3+0+4) | M | [tasks/DK-292.md](tasks/DK-292.md) |
...
| DK-306 | LLD: очередь слияния при занятом выкате | LLD | P2 | 39 (25+7+3+0+4) | M | [tasks/DK-306.md](tasks/DK-306.md) |
