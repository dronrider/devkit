...
| DK-151 | Установка и обновление devkit на чистой машине без сборки из исходников [провал: сценарий п.1: --pin не отвязал чекаут, когда новейший тег стоит на том же коммите, что и main (tag == latest, переход пропущен); клон остался на ветке, и следующий update отказывает как дереву разработчика] | task | P2 | 41 (25+9+3+0+4) | M | [tasks/DK-151.md](tasks/DK-151.md) |
...
| DK-152 | doctor сверяет версии всех устанавливаемых бинарей, а не mtime четырёх | task | P2 | 35 (25+5+1+0+4) | M | [tasks/DK-138.md](tasks/DK-138.md) |
