...
|--------|--------|-----|---|---|------|--------|
| DK-240 | Первый прогон devkitctl corp одной командой: опрос контура и префикс из имени клона | task | P2 | 36 (25+6+2+0+3) | S | [tasks/DK-240.md](tasks/DK-240.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-248 | Редизайн экранов дашборда в Claude Design: форма задачи, шапка с логотипом, лента, индикаторы, состав цели, заведение | task | P2 | 37 (25+7+2+0+3) | M | [tasks/DK-248.md](tasks/DK-248.md) |
| DK-252 | Транскрипт активной задачи мешает чужие сессии: выбор по mtime вместо привязки к задаче | bug | P2 | 39 (25+5+3+5+1) | M | [tasks/DK-252.md](tasks/DK-252.md) |
| DK-253 | Остаток подписок на главной: снимки квоты подключаемыми модулями без хардкода харнесов | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-253.md](tasks/DK-253.md) |

## Backlog

| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-264 | cmdout: утилита-обёртка, полный вывод в файл, агенту выжимку | task | P2 | 41 (25+8+3+0+5) | M | [lld/DK-137-cmdout-wrapper.md](lld/DK-137-cmdout-wrapper.md) |
| DK-265 | regcheck на cmdout: хвосты обоих прогонов и пути к полным логам [после DK-264] | bug | P2 | 41 (25+5+2+5+4) | M | - |
...
| DK-237 | LLD: общий модуль каркаса go-утилит: 35 функций в копиях, 12 уже разошлись | LLD | P2 | 39 (25+7+3+0+4) | M | [tasks/DK-237.md](tasks/DK-237.md) |
...
| DK-236 | shipctl, agentctl и trackctl молча теряют флаг за позиционным: pick отдаёт вердикт не той роли [после DK-237] | bug | P2 | 37 (25+3+1+5+3) | M | [tasks/DK-236.md](tasks/DK-236.md) |
...
| DK-196 | Конец хода сессии из песочницы звонит баннером: хук-путь notify без фильтра временных корней | bug | P2 | 36 (25+3+1+5+2) | S | [tasks/DK-196.md](tasks/DK-196.md) |
| DK-148 | Регулярный замер расхода контекста по журналам сессий | task | P2 | 35 (25+6+1+0+3) | M | [tasks/DK-148.md](tasks/DK-148.md) |
| DK-184 | Скилл proofread для вычитки прозы с парами, словарём и сторожевым корпусом | task | P2 | 35 (25+7+1+0+2) | M | [lld/DK-173-agent-prose.md](lld/DK-173-agent-prose.md) |
...
| DK-249 | Реализация редизайна: форма и тексты экранов, логотип-переход, лента с колокольчиком, кружки статуса, флеш-уведомления [после DK-248] | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-249.md](tasks/DK-249.md) |
| DK-250 | Действия задачи по статусу: выполнить, продолжить, закрыть со своими промптами конвейеру [после DK-248] | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-250.md](tasks/DK-250.md) |
| DK-251 | Состав цели сабтасками, единая форма задача-черновик и раздел черновиков с оформлением [после DK-248] | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-251.md](tasks/DK-251.md) |
| DK-254 | Чат с агентом: открытие хвостом, якорь при обновлении, markdown и ссылки, время клиента, честные имена | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-254.md](tasks/DK-254.md) |
| DK-263 | Интерактивные сессии агентов видны в работах: живость по mtime транскрипта, включая окна боковых деревьев | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-263.md](tasks/DK-263.md) |
...
| DK-266 | shipctl на cmdout: 13 вызовов tail() в ops.go переезжают на обёртку [после DK-264] | task | P2 | 33 (25+4+1+0+3) | M | - |
| DK-122 | Отказ «конвейер занят» не говорит, кто держит замок | task | P2 | 32 (25+4+1+0+2) | S | [tasks/DK-122.md](tasks/DK-122.md) |
| DK-185 | Точки вызова вычитки и короткий формат служебных записей [после DK-184] | task | P2 | 32 (25+5+1+0+1) | S | [lld/DK-173-agent-prose.md](lld/DK-173-agent-prose.md) |
| DK-255 | Экран агента: журнал цели из файла при чате-цикле, заголовок вместо имени сессии, формулировки | task | P2 | 32 (25+5+2+0+0) | M | [tasks/DK-255.md](tasks/DK-255.md) |
| DK-256 | Экран «Агенты»: живые агенты всех проектов списком, переходы в статус и чат [после DK-248] | task | P2 | 32 (25+5+1+0+1) | M | [tasks/DK-256.md](tasks/DK-256.md) |
...
| DK-268 | правило про длинные прогоны в долгоживящей доке | task | P3 | 9 (0+4+1+0+4) | S | - |
...
| DK-267 | cmdout: чистка старых выводов, гитигнор, находка doctor [после DK-264] | task | P3 | 6 (0+2+2+0+2) | S | - |
