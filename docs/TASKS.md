...
|--------|--------|-----|---|---|------|--------|
| DK-005 | shipctl start: worktree на задачу, чтобы параллельные сессии не толкались в одном дереве | task | P2 | 34 (25+4+1+0+4) | M | [tasks/DK-005.md](tasks/DK-005.md) |
| DK-006 | agentctl: выбор модели под задачу по метаданным доски для делегирования субагенту | task | P3 | 8 (0+3+1+0+4) | M | [tasks/DK-006.md](tasks/DK-006.md) |
