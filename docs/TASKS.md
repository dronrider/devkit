...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-065 | Факт выката хранится строкой задачи, а не выводится поиском ID в сабджекте | task | P2 | 38 (25+7+3+0+3) | M | [tasks/DK-065.md](tasks/DK-065.md) |
...
| DK-066 | Два исхода проверки: провал выката и приёмка с замечаниями, непроверенный выкат виден после возврата в работу [после DK-065] | task | P2 | 36 (25+6+3+0+2) | M | [tasks/DK-066.md](tasks/DK-066.md) |
