...
| DK-096 | оболочка goal-run: tmux-цикл витков, замок, защита от воронки, уведомления | task | P2 | 37 (25+7+2+0+3) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
