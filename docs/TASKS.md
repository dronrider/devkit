...
| DK-079 | Автономный цикл разработки: цель, лимит трат и самоперезапуск | LLD | P3 | 18 (0+9+5+0+4) | M | [tasks/DK-079.md](tasks/DK-079.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-074 | Корпоративный контур: конвейер devkit поверх внешнего трекера без следов ИИ | LLD | P2 | 42 (25+8+5+0+4) | L | [tasks/DK-074.md](tasks/DK-074.md) |
