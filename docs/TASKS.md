...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-345 | почта любой живой сессии, а не только витка цели | task | P1 | 65 (50+8+2+0+5) | M | [tasks/DK-345.md](tasks/DK-345.md) |
...
| DK-402 | Парковка задачи по вопросу и пробуждение тиком watch [после DK-345] | task | P1 | 63 (50+8+1+0+4) | M | [tasks/DK-402.md](tasks/DK-402.md) |
