...
| DK-177 | Назначение яруса в машинном слое: строка via и запись про подписку [после DK-090] | task | P2 | 40 (25+8+2+0+5) | M | [tasks/DK-171.md](tasks/DK-171.md) |
| DK-040 | agentctl run: делегирование native/cli/none с ограничителем вложенности [после DK-090] | task | P2 | 39 (25+8+2+0+4) | L | [lld/DK-033-universal-kit.md](lld/DK-033-universal-kit.md) |
...
| DK-178 | agentctl run отдаёт работу харнесу назначения: каталог и окружение подпроцесса [после DK-177, DK-040] | task | P2 | 39 (25+8+2+0+4) | M | [tasks/DK-171.md](tasks/DK-171.md) |
| DK-179 | Раскладка машинного контура по профилям включённых харнесов [после DK-090] | task | P2 | 39 (25+7+2+0+5) | M | [tasks/DK-171.md](tasks/DK-171.md) |
...
| DK-182 | Корректор считает ступень по её подписке [после DK-177, DK-181] | task | P3 | 11 (0+7+2+0+2) | M | [tasks/DK-171.md](tasks/DK-171.md) |
