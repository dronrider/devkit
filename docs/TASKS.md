...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-362 | dashboard: headless-запуск с доски не наблюдаем, чата нет в сессиях | bug | P2 | 41 (25+7+2+5+2) | M | [tasks/DK-362.md](tasks/DK-362.md) |
| DK-344 | goal-run.py --ask: вопрос человеку с ожиданием ответа и отметкой в ящике | task | P2 | 35 (25+6+2+0+2) | M | [tasks/DK-344.md](tasks/DK-344.md) |
...
| DK-360 | Дашборд различает сессию-вопрос и сессию-заказ при узнавании задачи | bug | P2 | 37 (25+5+2+5+0) | M | [tasks/DK-360.md](tasks/DK-360.md) |
