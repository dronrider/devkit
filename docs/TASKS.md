...
| DK-205 | Доставка правил через .devkit: ссылки в дереве задачи от shipctl start | task | P2 | 36 (25+3+1+5+2) | S | [lld/DK-193-rules-delivery.md](lld/DK-193-rules-delivery.md) |
