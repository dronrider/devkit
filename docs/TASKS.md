...
| DK-403 | Отвязка wait-human от стопа цикла цели | task | P1 | 63 (50+8+1+0+4) | S | [tasks/DK-403.md](tasks/DK-403.md) |
| DK-404 | Планировщик слота: ворота, счёт внутри полосы, разбор отказа | task | P2 | 39 (25+8+1+0+5) | L | [tasks/DK-404.md](tasks/DK-404.md) |
...
| DK-421 | Правила доки фичи: вход для читателя, впервые её видящего, и проверка чужим контекстом | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-421.md](tasks/DK-421.md) |
...
| DK-420 | Дока запускатора окна второй подписки: порядок первого запуска с нуля | task | P2 | 33 (25+5+1+0+2) | S | [tasks/DK-420.md](tasks/DK-420.md) |
