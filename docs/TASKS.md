...
| DK-175 | Запускатор vscode с конфигом z.ai: своё окно на второй подписке и dry-run окружения | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-171.md](tasks/DK-171.md) |
...
| DK-174 | Скилл командной работы над одним проектом: захват задачи и разбор столкновений | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-171.md](tasks/DK-171.md) |
| DK-040 | agentctl run: делегирование native/cli/none с ограничителем вложенности [после DK-090] | task | P2 | 37 (25+6+2+0+4) | L | [lld/DK-033-universal-kit.md](lld/DK-033-universal-kit.md) |
