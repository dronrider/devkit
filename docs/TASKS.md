...
| DK-236 | shipctl, agentctl и trackctl молча теряют флаг за позиционным: pick отдаёт вердикт не той роли | bug | P2 | 39 (25+3+3+5+3) | M | [tasks/DK-236.md](tasks/DK-236.md) |
