...
| DK-317 | dashboard: строка задачи не знает про идущую работу, ни признака, ни стопа | bug | P2 | 43 (25+8+3+5+2) | M | [tasks/DK-317.md](tasks/DK-317.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-289 | dashboard: кнопка «Закрыть» поднимает сессию агента и молчит про это | bug | P2 | 43 (25+8+3+5+2) | M | [tasks/DK-289.md](tasks/DK-289.md) |
...
| DK-305 | dashboard: экран агента на телефоне, вкладка разговора и подпись живого потока | bug | P2 | 37 (25+6+1+5+0) | S | [tasks/DK-305.md](tasks/DK-305.md) |
