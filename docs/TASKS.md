...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-402 | Парковка задачи по вопросу и пробуждение тиком watch | task | P1 | 63 (50+8+1+0+4) | M | [tasks/DK-402.md](tasks/DK-402.md) |

## Backlog

| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-397 | Цель: дашборд ведёт разговор вокруг задачи [приёмка: mixed] | task | P1 | 66 (50+9+3+0+4) | XL | [tasks/DK-397.md](tasks/DK-397.md) |
| DK-269 | Отставание бокового дерева от main не видно и чинится руками | task | P1 | 63 (50+6+3+0+4) | L | [tasks/DK-269.md](tasks/DK-269.md) |
| DK-403 | Отвязка wait-human от стопа цикла цели [после DK-402] | task | P1 | 63 (50+8+1+0+4) | S | [tasks/DK-403.md](tasks/DK-403.md) |
| DK-413 | trackctl: адаптер Jira ходит только в API v3, на v2 не работает | task | P1 | 62 (50+7+3+0+2) | M | [tasks/DK-413.md](tasks/DK-413.md) |
| DK-414 | trackctl: команда правки тикета, оценка, исполнитель, статус, комментарий и поля | task | P1 | 61 (50+7+2+0+2) | M | [tasks/DK-414.md](tasks/DK-414.md) |
| DK-331 | Раскладка скиллов везёт один SKILL.md, вычитка на машине без пар и словаря | bug | P2 | 43 (25+7+2+5+4) | S | [tasks/DK-331.md](tasks/DK-331.md) |
| DK-181 | Съёмщик остатка второй подписки: quota --harness | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-181.md](tasks/DK-181.md) |
| DK-371 | Лента чата выносится в куски с параметрами, цель остаётся на них | task | P2 | 40 (25+8+2+0+5) | M | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-372 | Лента черновика: ручка склейки заходов со стримом, экран с лентой и полем ввода [после DK-371] | task | P2 | 40 (25+8+2+0+5) | M | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-373 | Живой вопрос грумера: ящик, draft ask, ручка письма, блок пачки, скилл [после DK-372] | task | P2 | 40 (25+8+3+0+4) | L | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-379 | Сторож делегирования: расход вложенных субагентов виден и ограничен | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-379.md](tasks/DK-379.md) |
| DK-183 | Цель: ревью оставляет след и закрывается за два круга | task | P2 | 39 (25+8+2+0+4) | XL | [tasks/DK-183.md](tasks/DK-183.md) |
| DK-364 | Назначение исполнителя с учётом остатков подписок [после DK-181] | task | P2 | 39 (25+8+2+0+4) | M | [tasks/DK-364.md](tasks/DK-364.md) |
| DK-404 | Планировщик слота: ворота, счёт внутри полосы, разбор отказа [после DK-402] | task | P2 | 39 (25+8+1+0+5) | L | [tasks/DK-404.md](tasks/DK-404.md) |
| DK-411 | dashboard: экран задачи и колонка проектов пересобираются на каждый фокус окна | bug | P2 | 39 (25+5+2+5+2) | M | [tasks/DK-411.md](tasks/DK-411.md) |
...
| DK-162 | Скилл безопасности: опросник модели угроз и чеклист по классам дыр | task | P2 | 38 (25+6+3+0+4) | M | [tasks/DK-162.md](tasks/DK-162.md) |
...
| DK-369 | Правка текста черновика: ручка PUT с замком разбора и редактор экрана записи | task | P2 | 37 (25+8+1+0+3) | M | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
...
| DK-176 | taskctl add и set молча кладут в строку битую ссылку на путь от корня репозитория | bug | P2 | 36 (25+3+1+5+2) | S | [tasks/DK-176.md](tasks/DK-176.md) |
| DK-350 | Дашборд: форма заведения помнит черновики, лишние поля гасятся | bug | P2 | 36 (25+5+1+5+0) | S | [tasks/DK-350.md](tasks/DK-350.md) |
...
| DK-370 | Форма записи: кнопки «Сохранить» и «Сохранить и грумить», промежуточный экран уходит | task | P2 | 35 (25+8+1+0+1) | S | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-398 | goal-start сверяет бюджет цели с остатком бакета до сброса | task | P2 | 35 (25+6+1+0+3) | S | [tasks/DK-398.md](tasks/DK-398.md) |
| DK-405 | Полка фона и потолки незакрытых деревьев и висящих вопросов [после DK-404] | task | P2 | 35 (25+5+1+0+4) | M | [tasks/DK-405.md](tasks/DK-405.md) |
| DK-417 | trackctl: описание и связи тикета правятся из devkit [после DK-414] [приёмка: mixed] | task | P2 | 35 (25+5+3+0+2) | M | [tasks/DK-417.md](tasks/DK-417.md) |
| DK-355 | dashboard: кружок статуса и колонка хода в строке доски [приёмка: mixed] | task | P2 | 34 (25+7+1+0+1) | M | [tasks/DK-355.md](tasks/DK-355.md) |
| DK-356 | dashboard: карта «Ход работы» на экране задачи [приёмка: mixed] | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-356.md](tasks/DK-356.md) |
...
| DK-088 | LLD имитации человеческого темпа в трекере: строить ли вообще [приёмка: user] | LLD | P3 | 10 (0+3+5+0+2) | - | [tasks/DK-088.md](tasks/DK-088.md) |
...
| DK-049 | своё приложение-отправитель уведомлений: иконка devkit вместо иконки terminal-notifier [приёмка: mixed] | task | P3 | 6 (0+3+3+0+0) | M | [tasks/DK-049.md](tasks/DK-049.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-419 | одноразовая строка сценария DK-402 [блок: вопрос: сценарий DK-402, ответ лежит в ящике] | task | P3 | 1 (0+1+0+0+0) | S | [tasks/DK-419.md](tasks/DK-419.md) |
