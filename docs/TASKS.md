...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-264 | cmdout: утилита-обёртка на общем go-модуле, полный вывод в файл, агенту выжимку [после DK-237] | task | P2 | 41 (25+8+3+0+5) | M | [lld/DK-137-cmdout-wrapper.md](lld/DK-137-cmdout-wrapper.md) |
| DK-265 | regcheck: хвосты обоих прогонов и пути к полным логам | bug | P2 | 41 (25+5+2+5+4) | M | - |
