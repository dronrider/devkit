...
|--------|--------|-----|---|---|------|--------|
| DK-388 | Цель: единые ворота заведения строки доски при любом входе | task | P2 | 38 (25+7+2+0+4) | XL | [tasks/DK-388.md](tasks/DK-388.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-331 | Раскладка скиллов везёт один SKILL.md, вычитка на машине без пар и словаря | bug | P2 | 42 (25+6+2+5+4) | S | [tasks/DK-331.md](tasks/DK-331.md) |
...
| DK-345 | почта любой живой сессии, а не только витка цели | task | P3 | 11 (0+6+2+0+3) | M | - |
...
| DK-394 | taskctl add заводит файл задачи с пустым DoD, изменяющие команды без файла отказывают [после DK-389] | task | P3 | 7 (0+3+2+0+2) | M | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
...
| DK-391 | board-task: что идёт строкой сразу и что в черновик, файл задачи при заведении, а не при взятии в работу [после DK-389, DK-390] | task | P3 | 6 (0+3+1+0+2) | M | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
| DK-262 | Приёмочный тест из сценария проверки задачи | task | P3 | 5 (0+2+1+0+2) | S | [tasks/DK-262.md](tasks/DK-262.md) |
| DK-389 | Строка доски получает файл задачи с DoD при заведении: абзац в п. 5 правил доски | task | P3 | 5 (0+3+0+0+2) | S | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
...
| DK-392 | goal-loop и goal-cut: ворота заменяются связью с целью, ссылка на цель уходит в файл задачи нарезки [после DK-389] | task | P3 | 4 (0+2+1+0+1) | S | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
| DK-390 | board-groom держит полное описание трёх ворот, прочие входы ссылаются туда [после DK-389] | task | P3 | 3 (0+2+0+0+1) | S | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
| DK-393 | goal-start: ворота постановки заменяются DoD цели и бюджетом [после DK-389] | task | P3 | 3 (0+2+0+0+1) | S | [docs/tasks/DK-388.md](docs/tasks/DK-388.md) |
