...
| DK-055 | Ревью бага идёт по пути от симптома к правке: звено вне диффа обосновывается вслух, сценарий проверки начинается с воспроизведения бага | task | P2 | 36 (25+6+1+0+4) | S | [tasks/DK-055.md](tasks/DK-055.md) |
