...
|--------|--------|-----|---|---|------|--------|
| DK-060 | CI-шаг проверки символов всегда красный: он ловит чужой вывод панели в agentctl/testdata | bug | P2 | 34 (25+3+0+5+1) | S | [tasks/DK-060.md](tasks/DK-060.md) |

## Check (готово, ждёт проверки пользователем)

| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-061 | клик по уведомлению открывает лишнее окно worktree вместо окна сессии | bug | P2 | 35 (25+4+1+5+0) | S | [tasks/DK-061.md](tasks/DK-061.md) |
