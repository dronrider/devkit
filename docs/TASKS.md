...
| DK-099 | taskctl: разбор аргументов подкоманд молча теряет данные (позиционный после флага, имя несуществующей подкоманды) | bug | P2 | 37 (25+4+1+5+2) | M | [tasks/DK-099.md](tasks/DK-099.md) |
