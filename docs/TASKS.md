...
| DK-130 | board-groom: исследование черновика до оформления, режимы захода и тест скилла [после DK-132] | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-128.md](tasks/DK-128.md) |
| DK-132 | taskctl: исходы разбора черновика, команды defer, attach и drop | task | P2 | 38 (25+7+1+0+5) | M | [tasks/DK-132.md](tasks/DK-132.md) |
