...
|--------|--------|-----|---|---|------|--------|
| DK-193 | LLD: доставка правил devkit в сессии подключённых проектов | LLD | P2 | 44 (25+7+3+5+4) | M | [tasks/DK-193.md](tasks/DK-193.md) |
...
| DK-204 | Доставка правил через .devkit: ссылки и тонкий файл в devkitctl | task | P2 | 42 (25+7+1+5+4) | M | [lld/DK-193-rules-delivery.md](lld/DK-193-rules-delivery.md) |
