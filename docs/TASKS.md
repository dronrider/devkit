...
| DK-164 | второе обновление на машине потребителя отказывает: отставший origin/main выдаёт тег за неотправленную работу | bug | P1 | 66 (50+7+1+5+3) | S | [tasks/DK-164.md](tasks/DK-164.md) |
