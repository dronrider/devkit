...
| DK-279 | dashboard: производная tmux-сессия становится мусорной работой на экране | bug | P2 | 38 (25+5+1+5+2) | S | [tasks/DK-279.md](tasks/DK-279.md) |
...
| DK-281 | dashboard: сообщение агенту идёт без статуса отправки и дублируется повтором | bug | P2 | 40 (25+6+2+5+2) | M | [tasks/DK-281.md](tasks/DK-281.md) |
...
| DK-277 | shipctl merge считает открытым замечанием любую строку раздела «Ревью» с маркером списка | bug | P2 | 38 (25+3+2+5+3) | S | [tasks/DK-277.md](tasks/DK-277.md) |
...
| DK-283 | Тестовый стенд дашборда пишет уведомления в живой журнал машины | bug | P2 | 37 (25+4+1+5+2) | S | [tasks/DK-283.md](tasks/DK-283.md) |
...
| DK-282 | dashboard: флеш-уведомление нечем закрыть | task | P2 | 31 (25+5+1+0+0) | S | [tasks/DK-282.md](tasks/DK-282.md) |
