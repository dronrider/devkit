...
| DK-139 | LLD: раскладка каталогов devkit и правило выбора языка инструмента | LLD | P2 | 41 (25+6+5+0+5) | M | [tasks/DK-135.md](tasks/DK-135.md) |
...
| DK-140 | переезд файлов devkit по новой раскладке с починкой путей на машинах [после DK-139] | task | P2 | 37 (25+5+3+0+4) | M | [tasks/DK-135.md](tasks/DK-135.md) |
