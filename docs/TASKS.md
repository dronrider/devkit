...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-327 | Цель: пользовательские сценарии дашборда проходят с экрана целиком, без терминала и F5 [блок: бюджет исчерпан: week_all 27 из 25, week_max 18 из 15] | task | P1 | 66 (50+9+3+0+4) | XL | [tasks/DK-327.md](tasks/DK-327.md) |
