...
| DK-391 | board-task: что идёт строкой сразу и что в черновик, файл задачи при заведении, а не при взятии в работу | task | P3 | 6 (0+3+1+0+2) | M | [tasks/DK-388.md](tasks/DK-388.md) |
