...
|--------|--------|-----|---|---|------|--------|
| DK-205 | Доставка правил через .devkit: ссылки в дереве задачи от shipctl start | task | P2 | 36 (25+3+1+5+2) | S | [tasks/DK-205.md](tasks/DK-205.md) |
...
| DK-191 | taskctl/shipctl: команда перехода печатает следующий шаг конвейера | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-191.md](tasks/DK-191.md) |
