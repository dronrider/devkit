...
| DK-093 | agentctl: гейт бюджета цели (spend) и потолок яруса в pick (--goal) | task | P2 | 39 (25+7+2+0+5) | M | [tasks/DK-093.md](tasks/DK-093.md) |
| DK-097 | скилл live-core: порог, канал через порядок devkit, границы | task | P3 | 9 (0+5+2+0+2) | S | [tasks/DK-097.md](tasks/DK-097.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-094 | скилл goal-loop, вход постановки: разделы файла цели, строка XL на доске, бюджет диалогом | task | P2 | 38 (25+7+1+0+5) | M | [tasks/DK-094.md](tasks/DK-094.md) |
