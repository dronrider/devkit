...
| DK-129 | LLD: организация груминга черновиков, критерий готовности и режимы захода | LLD | P2 | 38 (25+4+5+0+4) | M | [tasks/DK-129.md](tasks/DK-129.md) |
...
| DK-130 | board-groom: исследование черновика до оформления, режимы захода и тест скилла [после DK-129] | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-128.md](tasks/DK-128.md) |
...
| DK-131 | Разбор накопителя черновиков devkit доработанным board-groom [после DK-130] | task | P2 | 35 (25+6+1+0+3) | M | [tasks/DK-128.md](tasks/DK-128.md) |
