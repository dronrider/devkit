...
| DK-326 | dashboard: выбор подписки при запуске работы | task | P2 | 39 (25+8+3+0+3) | M | [tasks/DK-326.md](tasks/DK-326.md) |
| DK-325 | dashboard: поиск задач по доске и архиву | task | P2 | 37 (25+7+3+0+2) | M | [tasks/DK-325.md](tasks/DK-325.md) |
| DK-321 | dashboard: груминг черновика зовётся грумингом, исход виден, черновик удаляется | task | P2 | 35 (25+6+3+0+1) | M | [tasks/DK-321.md](tasks/DK-321.md) |
...
| DK-294 | dashboard: разговор живой сессии без узнанной задачи не открыть | task | P2 | 34 (25+5+3+0+1) | M | [tasks/DK-327.md](tasks/DK-327.md) |
