...
| DK-401 | Рубеж задачи машинным состоянием, переживающим смену статуса | task | P2 | 37 (25+7+1+0+4) | M | [tasks/DK-401.md](tasks/DK-401.md) |
| DK-406 | Двухступенчатый Check: агентский прогон после выката освобождает очередь | task | P1 | 61 (50+7+1+0+3) | M | [tasks/DK-406.md](tasks/DK-406.md) |
