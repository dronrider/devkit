...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-075 | doctor --fix дописывает недостающие ключи в готовый deploy.local, а не только в болванку new | task | P2 | 34 (25+4+1+0+4) | S | [tasks/DK-075.md](tasks/DK-075.md) |
