...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-089 | Выбор модели опирается на недельный лимит, который профиль трат описывает неверно | bug | P2 | 42 (25+5+3+5+4) | M | [tasks/DK-089.md](tasks/DK-089.md) |
...
| DK-117 | Витки цели видны из чата: первый идёт в самом чате, ход фонового наблюдаем до завершения | task | P2 | 41 (25+8+3+0+5) | M | [tasks/DK-117.md](tasks/DK-117.md) |
