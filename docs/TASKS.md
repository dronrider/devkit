...
| DK-227 | Значения секретов переезжают из access.local.md в secretctl | task | P1 | 62 (50+7+2+0+3) | M | [tasks/DK-227.md](tasks/DK-227.md) |
| DK-230 | check-sensitive: скоуп шире доски и паттерн корп-доменов, obeycheck | task | P2 | 38 (25+6+3+0+4) | M | [tasks/DK-230.md](tasks/DK-230.md) |
| DK-231 | Транскрипты ~/.claude/projects очищены от утёкших тел токенов | task | P2 | 34 (25+5+2+0+2) | M | [tasks/DK-231.md](tasks/DK-231.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-223 | Заход извне и проверка дашборда с телефона | task | P2 | 34 (25+6+3+0+0) | S | [tasks/DK-223.md](tasks/DK-223.md) |
...
| DK-242 | Экраны дашборда открываются секунды: профилировать и убрать ожидание из стартовой и карточки задачи | task | P2 | 36 (25+7+3+0+1) | M | [tasks/DK-242.md](tasks/DK-242.md) |
...
| DK-232 | Корп-домен вычищен из дерева и истории, force-push пользователя [после DK-230] | task | P2 | 34 (25+5+2+0+2) | M | [tasks/DK-232.md](tasks/DK-232.md) |
| DK-243 | Доска дашборда: действия со строки, ранг тултипом, дата статуса вместо возраста, кнопка на главную | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-243.md](tasks/DK-243.md) |
| DK-245 | Заведение задачи и черновика с дашборда | task | P2 | 34 (25+6+2+0+1) | M | [tasks/DK-245.md](tasks/DK-245.md) |
...
| DK-244 | Экран задачи дашборда: единая кнопка сохранения, валидация слагаемых по типу, спокойное живое обновление | task | P2 | 32 (25+5+2+0+0) | M | [tasks/DK-244.md](tasks/DK-244.md) |
...
| DK-246 | Лента уведомлений входом с колокольчика, а не пунктом меню | task | P3 | 6 (0+4+2+0+0) | S | [tasks/DK-246.md](tasks/DK-246.md) |
