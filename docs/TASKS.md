...
|--------|--------|-----|---|---|------|--------|
| DK-160 | doctor из каталога проектов ползёт по чужим репозиториям и печатает сотни ложных находок | bug | P2 | 39 (25+5+1+5+3) | S | [tasks/DK-160.md](tasks/DK-160.md) |
