...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-204 | Доставка правил через .devkit: ссылки и тонкий файл в devkitctl | task | P2 | 42 (25+7+1+5+4) | M | [tasks/DK-204.md](tasks/DK-204.md) |
...
| DK-205 | Доставка правил через .devkit: ссылки в дереве задачи от shipctl start [после DK-204] | task | P2 | 36 (25+3+1+5+2) | S | [lld/DK-193-rules-delivery.md](lld/DK-193-rules-delivery.md) |
