...
| DK-314 | Headless-конвейер дашборда теряет исполнителей: фоновый субагент гибнет через 10 минут | bug | P1 | 71 (50+9+3+5+4) | M | [tasks/DK-314.md](tasks/DK-314.md) |
| DK-309 | Ручки дашборда отказывают молча: в журнале нет ни отказа, ни попытки | bug | P2 | 38 (25+6+0+5+2) | S | [tasks/DK-309.md](tasks/DK-309.md) |
| DK-328 | LLD: макеты дашборда, перетаскивание с пересчётом ранга, поиск, выбор подписки, экран груминга [приёмка: user] | LLD | P2 | 39 (25+7+3+0+4) | M | [tasks/DK-328.md](tasks/DK-328.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-316 | dashboard: перерисовка дёргает экран, позиция скролла и чат прыгают [приёмка: mixed] | bug | P2 | 45 (25+8+3+5+4) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-289 | dashboard: кнопка «Закрыть» поднимает сессию агента и молчит про это [после DK-316] | bug | P2 | 43 (25+8+3+5+2) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-317 | dashboard: строка задачи не знает про идущую работу, ни признака, ни стопа [после DK-316, DK-314] | bug | P2 | 43 (25+8+3+5+2) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-290 | dashboard: лента задачи склеивает разговоры разных сессий | bug | P2 | 41 (25+7+3+5+1) | M | [tasks/DK-290.md](tasks/DK-290.md) |
...
| DK-319 | dashboard: сообщение агенту ждёт витка, который никто не поднимет | bug | P2 | 40 (25+7+2+5+1) | S | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-326 | dashboard: выбор подписки при запуске работы [после DK-328, DK-314] | task | P2 | 39 (25+8+3+0+3) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-300 | Рубеж против фиктивного агентского сценария: вопрос ревью и ворота close | task | P2 | 37 (25+7+2+0+3) | S | [lld/DK-292-check-kind.md](lld/DK-292-check-kind.md) |
| DK-305 | dashboard: экран агента на телефоне, вкладка разговора и подпись живого потока [после DK-316] | bug | P2 | 37 (25+6+1+5+0) | S | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-325 | dashboard: поиск задач по доске и архиву [после DK-328] | task | P2 | 37 (25+7+3+0+2) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-301 | Дашборд заводит задачу с видом приёмки, флаг add становится обязательным | task | P2 | 36 (25+6+2+0+3) | M | [lld/DK-292-check-kind.md](lld/DK-292-check-kind.md) |
| DK-323 | Событие уведомителя несёт задачу и проект полем, а не догадкой ленты | task | P2 | 36 (25+6+3+0+2) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-321 | dashboard: груминг черновика зовётся грумингом, исход виден, черновик удаляется [после DK-328] | task | P2 | 35 (25+6+3+0+1) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-294 | dashboard: разговор живой сессии без узнанной задачи не открыть [после DK-290] | task | P2 | 34 (25+5+3+0+1) | M | [tasks/DK-327.md](tasks/DK-327.md) |
| DK-303 | Открытые строки доски получают вид приёмки по критериям | task | P2 | 34 (25+6+0+0+3) | S | [lld/DK-292-check-kind.md](lld/DK-292-check-kind.md) |
| DK-324 | dashboard: движение задачи в бэклоге перетаскиванием с пересчётом ранга [после DK-328] [приёмка: mixed] | task | P2 | 34 (25+6+3+0+0) | M | [tasks/DK-327.md](tasks/DK-327.md) |
...
| DK-304 | taskctl kinds: сводка по видам приёмки, расхождениям назначения и пересмотрам [после DK-303] | task | P3 | 7 (0+5+1+0+1) | S | [lld/DK-292-check-kind.md](lld/DK-292-check-kind.md) |
