...
| DK-141 | раннер тестов devkitctl на python вместо devkitctl/test.sh | task | P3 | 5 (0+0+1+0+4) | M | [tasks/DK-141.md](tasks/DK-141.md) |
| DK-142 | раннер тестов хуков на python вместо hooks/test.sh | task | P3 | 5 (0+0+1+0+4) | M | [tasks/DK-142.md](tasks/DK-142.md) |
| DK-143 | остаток sh по правилу выбора языка: раннеры скиллов и мелочь | task | P3 | 4 (0+0+1+0+3) | S | [tasks/DK-143.md](tasks/DK-143.md) |
...
| DK-144 | devkitctl doctor ловит файл не по правилу раскладки | task | P3 | 8 (0+3+1+0+4) | M | [tasks/DK-135.md](tasks/DK-135.md) |
