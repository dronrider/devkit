...
| DK-316 | dashboard: перерисовка дёргает экран, позиция скролла и чат прыгают [приёмка: mixed] | bug | P2 | 45 (25+8+3+5+4) | M | [tasks/DK-316.md](tasks/DK-316.md) |
| DK-323 | Событие уведомителя несёт задачу и проект полем, а не догадкой ленты | task | P2 | 36 (25+6+3+0+2) | M | [tasks/DK-323.md](tasks/DK-323.md) |
