...
| DK-218 | Запуск и стоп задачи и цели с дашборда | task | P2 | 39 (25+8+3+0+3) | M | [tasks/DK-218.md](tasks/DK-218.md) |
...
| DK-219 | Живой статус агента в дашборде: журнал витка, транскрипт, tmux | task | P2 | 38 (25+8+3+0+2) | M | [tasks/DK-219.md](tasks/DK-219.md) |
...
| DK-221 | Правка задачи и цели с дашборда, зависимости в обе стороны | task | P2 | 35 (25+5+3+0+2) | M | [tasks/DK-221.md](tasks/DK-221.md) |
