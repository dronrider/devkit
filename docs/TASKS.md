...
| DK-106 | Хуки вместо прозы: разбор в текстах находок, тесты в pre-commit, pre-push на запрет пуша | task | P2 | 37 (25+6+2+0+4) | M | [tasks/DK-106.md](tasks/DK-106.md) |

## Check (готово, ждёт проверки пользователем)

| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-113 | Права headless-витков цели: allowlist машинного контура через doctor и предполётная проверка goal-run | task | P1 | 65 (50+8+3+0+4) | M | [tasks/DK-113.md](tasks/DK-113.md) |
