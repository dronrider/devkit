...
| DK-372 | Лента черновика: ручка склейки заходов со стримом, экран с лентой и полем ввода | task | P2 | 40 (25+8+2+0+5) | M | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-373 | Живой вопрос грумера: ящик, draft ask, ручка письма, блок пачки, скилл | task | P2 | 40 (25+8+3+0+4) | L | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
...
| DK-133 | LLD: единые ворота заведения строки доски при любом входе [приёмка: user] | LLD | P2 | 38 (25+6+3+0+4) | M | [tasks/DK-133.md](tasks/DK-133.md) |
...
| DK-374 | Реплика в работающий заход: почтальон получает адрес черновика | task | P2 | 38 (25+8+2+0+3) | M | [lld/DK-354-draft-screen.md](lld/DK-354-draft-screen.md) |
| DK-375 | devkitctl map: генератор карты проекта и индекса решений, сторож свежести, импорт в тонкий файл | task | P2 | 38 (25+6+3+0+4) | M | [docs/tasks/DK-297.md](docs/tasks/DK-297.md) |
...
| DK-376 | POC-замер карты на xr-proxy: пара типовых задач с картой и без, цифры расхода [после DK-375] | task | P2 | 37 (25+6+2+0+4) | M | [docs/tasks/DK-297.md](docs/tasks/DK-297.md) |
