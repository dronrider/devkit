...
| DK-175 | Запускатор vscode с конфигом z.ai: своё окно на второй подписке и dry-run окружения | task | P2 | 40 (25+8+3+0+4) | M | [tasks/DK-175.md](tasks/DK-175.md) |
| DK-174 | Скилл командной работы над одним проектом: захват задачи и разбор столкновений | task | P2 | 38 (25+7+2+0+4) | M | [tasks/DK-174.md](tasks/DK-174.md) |
