...
| DK-082 | trackctl: адаптер трекера, конфиг контура, маппинг статусов | task | P3 | 14 (0+8+1+0+5) | M | [lld/DK-074-corp-contour.md](lld/DK-074-corp-contour.md) |
...
| DK-086 | Хуки корп-контура: обёртка чужих хуков и рубеж следов devkit | task | P3 | 11 (0+6+1+0+4) | M | [lld/DK-074-corp-contour.md](lld/DK-074-corp-contour.md) |
...
| DK-087 | shipctl: ветка по ключу тикета, отказ слияния в корп-контуре [после DK-082] | task | P3 | 10 (0+5+1+0+4) | S | [tasks/DK-087.md](tasks/DK-087.md) |
