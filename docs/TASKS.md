...
|--------|--------|-----|---|---|------|--------|
| DK-047 | клик по уведомлению переключает в окно сессии: отправитель terminal-notifier на macOS | task | P3 | 8 (0+6+2+0+0) | M | [tasks/DK-047.md](tasks/DK-047.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| DK-048 | LLD: диспетчер пачки задач, параллельное исполнение независимых задач бэклога | LLD | P3 | 15 (0+7+4+0+4) | M | - |
