...
| DK-095 | скилл goal-loop, виток: чтение состояния, нарезка, конвейер задачи, журнал, маркеры | task | P2 | 38 (25+8+2+0+3) | M | [lld/DK-079-autonomous-loop.md](lld/DK-079-autonomous-loop.md) |
