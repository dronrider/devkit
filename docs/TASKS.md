...
| DK-149 | LLD: чем доставляются готовые бинари devkit и откуда бинарь знает свою версию | LLD | P2 | 41 (25+7+5+0+4) | M | [tasks/DK-149.md](tasks/DK-149.md) |
...
| DK-150 | Бинари называют свой коммит, а собирает их релизная автоматика на macos и linux [после DK-149] | task | P2 | 41 (25+9+3+0+4) | M | [tasks/DK-138.md](tasks/DK-138.md) |
| DK-151 | Установка и обновление devkit на чистой машине без сборки из исходников [после DK-150] | task | P2 | 41 (25+9+3+0+4) | M | [tasks/DK-138.md](tasks/DK-138.md) |
...
| DK-152 | doctor сверяет версии всех устанавливаемых бинарей, а не mtime четырёх [после DK-150] | task | P2 | 35 (25+5+1+0+4) | M | [tasks/DK-138.md](tasks/DK-138.md) |
