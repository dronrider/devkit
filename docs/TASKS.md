...
| DK-141 | раннер тестов devkitctl на python вместо devkitctl/test.sh | task | P3 | 5 (0+0+1+0+4) | M | [tasks/DK-135.md](tasks/DK-135.md) |
| DK-142 | раннер тестов хуков на python вместо hooks/test.sh | task | P3 | 5 (0+0+1+0+4) | M | [tasks/DK-135.md](tasks/DK-135.md) |
| DK-143 | остаток sh по правилу выбора языка: раннеры скиллов и мелочь | task | P3 | 4 (0+0+1+0+3) | S | [tasks/DK-135.md](tasks/DK-135.md) |
