...
| DK-169 | goal-run: стоп без вердикта перезапускает виток, попытки ограничены, продолжение одной командой [после DK-153] | task | P2 | 38 (25+8+2+0+3) | M | [tasks/DK-156.md](tasks/DK-156.md) |
