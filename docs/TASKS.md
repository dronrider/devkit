...
| DK-110 | devkitctl weigh: живой замер резидента headless-прогоном и сверка с расчётом doctor [провал: живой замер не работает на macOS: слепок HOME без Library/Keychains, клиент отвечает Not logged in] | task | P3 | 13 (0+6+3+0+4) | M | [tasks/DK-110.md](tasks/DK-110.md) |
