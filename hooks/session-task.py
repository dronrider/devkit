...
Сессия, ведущая цикл цели, получает в поле носителя «цикл цели <ID>». Хук
узнаёт цель двумя дорогами: оболочка витка ставит её ID в DEVKIT_GOAL_SHELL, а
заход по строке доски узнаётся по тому, что файл задачи это запись цели.
Носитель живёт в реестре столько же, сколько строка рождения сессии. Свод
...
# в реестре чатов столько же, сколько сама строка рождения. Свод узнаёт цикл
# и назавтра, когда живой записи ~/.devkit/goals уже нет (DK-1088).
...
def carrier(env=None, goal=""):
    ...
    своя, на ID цели. Цель приезжает двумя дорогами. Оболочка витка ставит её
