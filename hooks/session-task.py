...
# команду открывает в 23 из 24. Оговорка «на каждой реплике» держит второй
# ход: без неё сессия, ответившая на простой вопрос, к работе на следующей
# реплике шла без скилла (сценарий 41, 4 из 5 против 5 из 5).
CHAT_RULE = ('На каждой реплике человека первым действием, до ответа ему, '
             'вызови скилл chat инструментом Skill: порядок разговора с '
             'человеком по задаче лежит в нём, без него ответ не по правилам.')
...
NO_TASK_CHAT_RULE = ('На каждой реплике человека первым действием, до ответа '
                      'ему, вызови скилл chat инструментом Skill и веди разговор '
