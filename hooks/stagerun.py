...
не на каждой машине и не в каждом PATH, и молчаливая пропажа этапа из-за него
...
этот счёт лежит в stagerun_test.py и в internal/stage/stage_test.go на одном и
том же тексте записи.
