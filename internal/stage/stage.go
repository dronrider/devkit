...
// конца, а не берёт только живой этап: спрашивающий (agentctl pick) хочет
...
// берёт только живой этап: спрашивают конкретный вид деятельности, а живым к
// моменту вопроса может стоять уже другой этап. Второе значение false, если
// этапа такого вида в записи нет вовсе.
