...
TAIL_MARKS = (
    "План работ веди командой agentctl plan",
    # Прежняя редакция правила плана (до DK-613): журналы за старые недели
    # лежат с ней, и корпус собирается по ним наравне со свежими.
