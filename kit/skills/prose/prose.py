...
def clean(text):
    """Реплика без оград кода. Ограды режутся, потому что в корпус едет проза,
    а не листинг, но реплику с кодом целиком не выбрасываем: вокруг листинга
    обычно и лежит нужный абзац.
