...
|--------|--------|-----|---|---|------|--------|
| OB-002 | README называет утилиту старым именем | task | P2 | 33 (25+4+1+0+3) | S | - |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| OB-001 | clamp не режет верхнюю границу | bug | P2 | 40 (25+5+1+5+4) | S | [tasks/OB-001.md](tasks/OB-001.md) |
