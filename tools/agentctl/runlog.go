...
// taskctl: статистика, какие команды реально гоняются и как часто падают.
// Журнал ведётся только там, где есть .devkit (обвязку заводит devkitctl),
// провал записи работу не ломает.
