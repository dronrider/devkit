...
const (
	...
	taskEnv = "DEVKIT_TASK"
	tmuxEnv = "DEVKIT_TMUX"
	// hiddenEnv метит делегата признаком «поднято без человека» (DK-847):
	// список чатов панели розданную работу не показывает вовсе, она видна
	// ходом в ленте раздавшего разговора (см. parentEnv выше), а не второй
	// строкой списка.
	hiddenEnv = "DEVKIT_HIDDEN"
