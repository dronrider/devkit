...
// Утренний случай DK-713 (стенд DoD DK-715): диспетчер цели спрашивает
// человека из живого tmux-чата, и печать блока паркует цель. Вопрос обязан быть виден в панели блоком (GET .../ask), ответ кнопкой
