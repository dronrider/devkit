...
// правилом на th и td, и стенд сверяет замер с ним. Пять точек человек
// забраковал («текст колонок стоит слишком близко к разделителю»), двенадцать
// забраковал с другого конца («отступы сжирают место»), и рубеж стоит на
// восьми: столько же отделяет друг от друга соседей внутри самой ячейки.
const tblSideMin = 8
