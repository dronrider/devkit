...
// агента гасит плашку сам и поднимает заново, если вход истёк второй раз. Тут
// же стенд читает style.css: hidden это атрибут, прячет его встроенное правило
// браузера, и авторский display у плашки его перебивал. Предмет проверки это
// собранная разметка и порядок вызовов, поэтому статика поднимается в node с
// заглушкой DOM (стенд
