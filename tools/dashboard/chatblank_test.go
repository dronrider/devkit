...
exit 0`)
	...
	// Имя tmux переиспользуется: до того его носил другой разговор, и его
	// запись реестра остаётся свежайшей с этим именем, пока клиент новой
	// сессии не назовётся. Расти в прежнего хозяина запись не должна (DK-851:
