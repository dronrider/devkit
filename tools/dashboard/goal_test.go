...
// agentTaskDoc это файл синтетической агентской задачи стенда. Раздела
// «Сценарий проверки» требуют ворота move check, а отметки обкатки (DK-643)
// у стенда взяться неоткуда: шагов, которые стоило бы гонять в свежем дереве,
// у выдуманной задачи нет. Ворот поэтому гасится пометкой-исключением с
// причиной, тем же способом, каким его гасит живая задача без прогоняемых
// шагов.
const agentTaskDoc = `# XR-004: Четвёртая
...
- Исключение: обкатка (синтетическая задача стенда, прогонять нечего)
`
