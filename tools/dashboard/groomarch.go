...
// последнего показа. Показ отмечает чтение ленты панелью.
//
// Разговор, который человек ни разу не открывал, считается непрочитанным весь,
// и срок тут не судья. Живой случай: чат разбора DK-502 стоит с вопросом к
// человеку, разбор при этом кончился строкой на доске, признак ожидания
// протух, и по возрасту хвоста такой чат уехал бы в архив вместе с вопросом.
