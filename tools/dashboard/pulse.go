...
func (s *server) handlePulse(w http.ResponseWriter, r *http.Request) {
	...
	// ведёт. Строка, припаркованная блоком, тихая и при живом соседе: у задачи
	// может идти неродственный разговор, а вопрос всё равно лежит в причине
	// блока, а не в его ленте, и моргание кольца обещало бы вопрос там, где
	// его нет и быть не может (приёмка человека DK-696, 2026-09-05: DK-565).
