...
const TBL_COLS = {
  tasks: [
    ...
    { key: "id", label: "Номер", by: "номеру", first: "asc", w: 88 },
  ...
  sess: [
    ...
    { key: "live", label: "Ход", by: "ходу работы", first: "asc", w: 76 },
    ...
    { key: "age", label: "Идёт", by: "времени работы", first: "desc", w: 104 },
  ...
  drafts: [
    ...
    { key: "prio", label: "Приоритет", by: "приоритету", first: "desc", w: 132 },
