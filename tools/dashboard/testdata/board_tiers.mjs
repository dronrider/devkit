...
// Первой кнопкой в строке стоит чат, он есть у каждой строки доски; причина
// невыполнимости живёт на кнопке действия, следующей за ним.
const btn = allByClass(held, "btn").find((b) => dump(b).includes("Выполнить")) || null;
