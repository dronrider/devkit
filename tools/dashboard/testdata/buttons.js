...
// и вычисленные свойства, и настоящий прямоугольник. Измерение радиуса
// (особенно правого для проверки DK-349) держит смок сегодняшней разметки: карточка
// кладётся вручную со своими классами, и смотрит наделённые им стили. Регрессию
// вырожденной кнопки без узкой части (одна подписка, непрочитанный список) держит
// экран настоящего app.js в testdata/screen_keep.mjs.
function shape(id) {
