...
// чужого проекта, а также два молчаливых случая: пустая полка и нечитаемая
// доска.
//
...
console.log("poc_waitshelf: полка собирает ждущих всех досок, вопрос виден текстом, " +
  "порядок сервера сохранён, строка ведёт в разговор ждущей сессии, чужой проект едет в адресе, " +
