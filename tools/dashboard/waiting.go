...
// agentPicks переводит варианты вопроса в пункты вопроса. Пункта свободного
// ответа тут больше нет: вопрос приходит текстом, и своими словами человек
// отвечает обычной репликой в чат.
