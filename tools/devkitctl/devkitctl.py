...
MACHINE_IGNORE_ENTRIES = (
    ...
    (".devkit/test-runs.log",
     "# Журнал итогов прогона test по компонентам (DK-1125), живёт только на машине.",
     "незагитигнорненный журнал ловится случайным git add и роняет следующий checkout слияния"),
)
