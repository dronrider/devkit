...
# grep приехал с обкаткой сценария (DK-643): шаг круга ищет строку задачи на
# доске, и в свежем дереве он идёт по подставному PATH стенда.
SYS_TOOLS = ("git", "python3", "sh", "dirname", "mkdir", "chmod", "rm", "grep")
