...
# носителей с живого окна на headless, и проверяется она целиком. Отказ идёт
# со словами настоящего tmux без сервера: код без слов каркас читает как
# сорванный опрос, и ворота взвода на нём отказывали (DK-904).
