...
// остаётся в каталоге прогона, см. saveAnswer. Обещание сверено с run.go: без
// --keep и без своего --work каталог прогона временный и сносится вместе с
// ответом (ревью DK-1056, замечание про пробел между текстом и поведением).
const judgeAnswerNote = "символы разбора судьи и заметок приведены к клавиатурным, дословный ответ судьи лежит в каталоге прогона (judge/answers) при --keep или своём --work, а без них каталог прогона временный и сносится вместе с ответом"
