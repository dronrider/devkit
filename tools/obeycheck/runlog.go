...
// taskctl, shipctl и regcheck: по журналу видно, гоняется ли стенд вообще и чем
// кончаются прогоны. Журнал ведётся только там, где есть .devkit, провал записи
// работу не ломает.
