...
Эта сессия открыта разговором про задачу OB-029. Первым действием, до ответа человеку, вызови скилл chat инструментом Skill: порядок разговора с человеком по задаче лежит в нём, без него ответ не по правилам.
