...
tasks/OB-NNN.md (имя по чистому ID, файл заводится, когда появляется
...
|--------|--------|-----|---|---|------|--------|
| OB-002 | README называет утилиту старым именем | task | P2 | 35 (25+4+1+0+3, S+2) | S | [tasks/OB-002.md](tasks/OB-002.md) |
...
| ID | Задача | Тип | P | R | Цена | Ссылка |
|--------|--------|-----|---|---|------|--------|
| OB-001 | clamp не режет верхнюю границу | bug | P2 | 42 (25+5+1+5+4, S+2) | S | [tasks/OB-001.md](tasks/OB-001.md) |
