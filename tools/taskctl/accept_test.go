...
// TestAddAcceptRequired: add без --accept отбивается, агентский вид заводится
// без суффикса и без --barrier, а --barrier у агентского лишний (LLD DK-292,
// решение 3). На старом коде (без поля Accept в AddParams) этой проверки нет
// вовсе, и тест падал на первой же строке.
