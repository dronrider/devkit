...
// chatQuestions переводит пачку в формат признака ожидания. Признак живёт
// своей жизнью: по нему панель знает, что сессия ждёт, а подхват отдаёт ждущему
// реплики человека.
...
// Длинное имя выигрывает у короткого: «выкат» и «выкат правил» различаются
// только хвостом, и короткое съело бы оба.
