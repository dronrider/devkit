...
type jsonRow struct {
	...
	// задача, от которой подтянут итог (DK-428). Своего счёта поправок у
	// читателя нет: дашборд правит ручкой пять слагаемых, а итог, свою сумму и
	// хвост берёт отсюда готовыми (DK-650).
